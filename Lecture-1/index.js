...
console.log(fruits);
// fruits.("2")
fruits = __spreadArray(__spreadArray(__spreadArray([], fruits.slice(0, 2), true), [
    "Mango"
], false), fruits.slice(2) // "orange", "grapes", "strawberry"
, true);
console.log(fruits);
console.log("############################");
//                                      0           1       2           3       4           5
var fruits_name = new Array("apple", "banana", "orange", "grapes", "strawberry");
"Kiwi";
fruits_name[2] = "Mango";
...
function function_name1(fruit_name1, fruit_name2) {
    //do something
    return 0;
}
function function_name2(fruit_name1, fruit_name2) {
    //do something
    return fruit_name1 + " " + fruit_name2;
}
var _fruits = function (fruit_name1, fruit_name2) {
    //do something
    return fruit_name1 + " " + fruit_name2;
};
...
var fullname = FullName("Kamran", "Ali");
